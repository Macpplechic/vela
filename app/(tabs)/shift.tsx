          ...
          <View key={p.id} style={styles.postCard}>
            <View style={styles.postHeader}>
              ...
              <View style={styles.postMeta}>
                ...
                <Text style={styles.postPhase}>{PHASES[p.phase]?.label ?? 'Peri'} · {p.time} ago</Text>
              </View>
...
const styles = StyleSheet.create({
  ...
  shareWinCard:{backgroundColor:Colors.plum,borderRadius:16,padding:16,marginBottom:12},
  shareWinTitle:{fontFamily:Fonts.sansMedium,fontSize:15,color:Colors.goldLight,marginBottom:4},
  shareWinSub:{fontFamily:Fonts.sans,fontSize:12,color:'rgba(255,255,255,0.5)'},
